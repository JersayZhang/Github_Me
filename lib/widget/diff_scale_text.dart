...
class _DiffScaleTextState extends State<DiffScaleText>
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget chils) {
          return RepaintBoundary(
            child: CustomPaint(
              ...
              foregroundPainter: _DiffText(
                  text: widget.text, textStyle: textStyle, progress: _animationController.value),
            ),
          );
        });
  }
...
class _DiffText extends CustomPainter {
  ...
  void drawText(Canvas canvas, String text, double textScaleFactor, double alphaFactor,
      Offset offset, _TextLayoutInfo textLayoutInfo) {
    var textPaint = Paint();
    if (alphaFactor == 1) {
    ...
    var textPainter = TextPainter(
        text: TextSpan(
            ...
            style: textStyle.merge(TextStyle(
                color: null, foreground: textPaint, textBaseline: TextBaseline.ideographic))),
        textDirection: TextDirection.ltr);
    ...
    textPainter.layout();
    textPainter.paint(
        canvas, Offset(offset.dx, offset.dy + (textLayoutInfo.height - textLayoutInfo.height) / 2));
  }
