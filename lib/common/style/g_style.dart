...
class GIcons {
  ...
  const IconData(0xe624, fontFamily: GIcons.FONT_FAMILY);
  static const IconData MORE =
  const IconData(0xe674, fontFamily: GIcons.FONT_FAMILY);
  static const IconData SEARCH =
  const IconData(0xe61c, fontFamily: GIcons.FONT_FAMILY);

  static const IconData MAIN_DT =
  const IconData(0xe684, fontFamily: GIcons.FONT_FAMILY);
  static const IconData MAIN_QS =
  const IconData(0xe818, fontFamily: GIcons.FONT_FAMILY);
  static const IconData MAIN_MY =
  const IconData(0xe6d0, fontFamily: GIcons.FONT_FAMILY);
  static const IconData MAIN_SEARCH =
  const IconData(0xe61c, fontFamily: GIcons.FONT_FAMILY);

  static const IconData LOGIN_USER =
  const IconData(0xe666, fontFamily: GIcons.FONT_FAMILY);
  static const IconData LOGIN_PW =
  const IconData(0xe60e, fontFamily: GIcons.FONT_FAMILY);

  static const IconData REPOS_ITEM_USER =
  const IconData(0xe63e, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_STAR =
  const IconData(0xe643, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_FORK =
  const IconData(0xe67e, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_ISSUE =
  const IconData(0xe661, fontFamily: GIcons.FONT_FAMILY);

  static const IconData REPOS_ITEM_STARED =
  const IconData(0xe698, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_WATCH =
  const IconData(0xe681, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_WATCHED =
  const IconData(0xe629, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_DIR = Icons.folder;
  static const IconData REPOS_ITEM_FILE =
  const IconData(0xea77, fontFamily: GIcons.FONT_FAMILY);
  static const IconData REPOS_ITEM_NEXT =
  const IconData(0xe610, fontFamily: GIcons.FONT_FAMILY);

  static const IconData USER_ITEM_COMPANY =
  const IconData(0xe63e, fontFamily: GIcons.FONT_FAMILY);
  static const IconData USER_ITEM_LOCATION =
  const IconData(0xe7e6, fontFamily: GIcons.FONT_FAMILY);
  static const IconData USER_ITEM_LINK =
  const IconData(0xe670, fontFamily: GIcons.FONT_FAMILY);
  static const IconData USER_NOTIFY =
  const IconData(0xe600, fontFamily: GIcons.FONT_FAMILY);

  static const IconData ISSUE_ITEM_ISSUE =
  const IconData(0xe661, fontFamily: GIcons.FONT_FAMILY);
  static const IconData ISSUE_ITEM_COMMENT =
  const IconData(0xe6ba, fontFamily: GIcons.FONT_FAMILY);
  static const IconData ISSUE_ITEM_ADD =
  const IconData(0xe662, fontFamily: GIcons.FONT_FAMILY);
  ...
  const IconData(0xe62f, fontFamily: GIcons.FONT_FAMILY);
